...
import { saveAddVisitor} from "../../../services/apartmentService";
const Addvisitor= () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      saveAddVisitor(formData).then((data) => {
        console.log(data);
      });
      alert("visitor sent successfully!");
    } catch (error) {
      console.error(error);
          ...
          <div className="fixed top-0 left-0 z-10 flex items-center justify-center w-full h-full overflow-hidden">
            ...
            <div className="z-10 w-full max-w-lg mx-auto overflow-y-auto bg-white rounded shadow-lg">
              ...
              <div className="p-4">
                ...
                <p className="mb-4">
                  Are you sure you want to submit this add Visitor request
                </p>
              </div>
